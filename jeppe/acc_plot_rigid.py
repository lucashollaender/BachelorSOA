...
axs[0].plot(t_rigid, gamma_body1, label="SOA")
axs[0].plot(adams1["TIME"], adams1["Q"], "--", label="Adams")
axs[0].set_ylabel("Joint acceleration [rad/s$^2$]")
axs[0].set_title("Joint Acceleration of Body 1")
axs[0].grid(True)
axs[0].legend()

axs[1].plot(t_rigid, gamma_body2, label="SOA")
axs[1].plot(adams2["TIME"], adams2["Q"], "--", label="Adams")
axs[1].set_xlabel("Time [s]")
axs[1].set_ylabel("Joint acceleration [rad/s$^2$]")
